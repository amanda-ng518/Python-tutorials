...
# Labels and title with font dictionaries
ax.set_xlabel("Weight", fontdict = font1) 
ax.set_ylabel("Height", fontdict = font2) 
...
# Scatter plot with marker and color settings
...
# Line plot with line style settings
